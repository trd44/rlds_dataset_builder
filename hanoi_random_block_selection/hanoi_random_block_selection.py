...
class HanoiRandomBlockSelection(tfds.core.GeneratorBasedBuilder):
                ...
                'steps': tfds.features.Dataset({
                    'observation': tfds.features.FeaturesDict({
                        ...
                        'state': tfds.features.Tensor(
                            shape=(8,),
                            dtype=np.float32,
                            doc='Robot Proprio state (3D EE Pos, 3D EE Axis Angle, 2D gripper).',
                        ),
                    }),
            ...
            for i, step in enumerate(seq):
                ...
                episode.append({
                    'observation': {
                        ...
                        'state': step['observation']['ee_state'],
                    },
                    'action': step['action'],
                    'discount': 1.0,
